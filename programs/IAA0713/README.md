...
النصوص المنقولة من المصدر **لا تُصحح بصمت**. عندما يظهر تعارض داخل الوثيقة نفسها، يبقى النص الأصلي كما هو في ملفات Markdown/JSON، ويُسجل التعارض والتطبيع - إن لزم - صراحة داخل `observed_anomalies` في الملف المطبّع.
